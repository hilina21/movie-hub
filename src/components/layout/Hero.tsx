  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-16 max-w-5xl">
        <div className="text-red-500 text-sm md:text-base font-bold mb-3 tracking-wider uppercase">Welcome to MovieHub</div>
        ...
        <div className="relative mt-4 w-full max-w-2xl">
          <input
            ...
            className="w-full bg-zinc-900/60 backdrop-blur-xl border border-zinc-700/50 rounded-full py-4 md:py-5 px-6 md:px-8 pl-12 md:pl-16 text-base md:text-lg focus:outline-none focus:border-red-500 focus:bg-zinc-900/90 focus:shadow-[0_0_30px_rgba(220,38,38,0.3)] transition-all shadow-2xl placeholder:text-zinc-400"
          />
